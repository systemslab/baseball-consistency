...
public class StaleBoundClient implements Runnable{
	static StaleBoundClient cl;
	public static void main(String args[])
	{
		cl = new StaleBoundClient();
		try	{
	...
	void startWriteClients(){
		Thread clientThread1 = new Thread(new StaleBoundClient());
		clientThread1.setName("Thread1");
		clientThread1.start();
		/*Thread clientThread2 = new Thread(new StaleBoundClient());
	...
	void startReadClients(){
		...
		strongReadThread1.setName("StaleBoundThread1");
