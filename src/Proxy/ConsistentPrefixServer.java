...
public class ConsistentPrefixServer extends UnicastRemoteObject implements Client_Proxy_interface {
	int cluster_size = 2;
	...
	long staleBoundLimit = 0, readTime = 0;
	HashMap<Integer, Integer> localStore[] = new HashMap[cluster_size];
	protected ConsistentPrefixServer() throws RemoteException {
		try {
		...
		System.out.println("CP Server started");
	}

	public static void main(String[] args) {
		try {
			ConsistentPrefixServer p = new ConsistentPrefixServer();
