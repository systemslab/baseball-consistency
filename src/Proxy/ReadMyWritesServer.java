...
public class ReadMyWritesServer extends UnicastRemoteObject implements Client_Proxy_interface {
	...
	protected ReadMyWritesServer() throws RemoteException {
		try {
		...
		System.out.println("ReadMyWrite Server started");
	}

	public static void main(String[] args) {
		try {
			ReadMyWritesServer p = new ReadMyWritesServer();
	...
	public String getWithLock(int key, Lock lock) throws RemoteException{
		...
		System.out.println("time taken for readmywrite with key "+key+" is "+ (nanos2-nanos));
